...
* The original package name 'com.project.distributed-codegen.config-service' is invalid and this project uses 'com.project.distributed_codegen.config_service' instead.
