...
import com.project.distributed_codegen.workspace_service.dto.project.ProjectRequest;
...
import com.project.distributed_codegen.workspace_service.mapper.ProjectMapper;
...
import com.project.distributed_codegen.workspace_service.security.SecurityExpressions;
...
public class ProjectServiceImpl implements ProjectService {
    ...
    public ProjectResponse createProject(ProjectRequest request) {
        ...
        ProjectMemberId projectMemberId =
                new ProjectMemberId(project.getId(), ownerUserId);
    ...
    public ProjectResponse updateProject(Long projectId, ProjectRequest request) {
        ...
        ProjectRole role = projectMemberRepository.findRoleByProjectIdAndUserId(projectId, userId)
                .orElseThrow(() -> new ResourceNotFoundException("Project membership", projectId.toString()));
